 ...
 * @author Carlos
 */
public class Postulante_nuevoController implements Initializable {
    ...
    private void boton_guardar(ActionEvent event) throws IOException {
        ...
        _usuario.setFechaNac(Date.valueOf(campoFechaNac.getValue()));
        _usuario.setNombre_usuario(campoDni.getText());
        _usuario.setDireccion(campoDireccion.getText());
        _usuario.setTelefono(campoTelefono.getText());
